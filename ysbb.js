(function () {
    // FlyClash compatible configuration script
    function overrideConfig(params) {
    ...
    function overwriteRules(params) {
        ...
        const ruleProviders = {
            ...
            microsoft_non_ip: {
                type: "http",
                behavior: "classical",
                url: "https://ruleseset.skk.moe/Clash/non_ip/microsoft.txt",
    ...
    // Export the configuration override function for FlyClash
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = overrideConfig;
    } else {
        window.overrideConfig = overrideConfig;
    }
})();
